							...
							<view @click="todetail(item.order)">
								...
								<view class="goods-area" :class="{ 'margin-top': goodsIndex > 0 }"
									...
									<view class="right flex1">
										...
										<view class="margin-top-sm">
											<text class="price ft-main fs-sm">{{ (goodsItem.goods_price / (1 - 0.2) / 100).toFixed(2)}}</text>
										</view>
									</view>
								</view>
								...
								<view class="dflex-e">
									<text class="fs-xs margin-right-xs">实付款</text>
									<text class="price ft-main">{{ (item.order.order_actural_paid / (1 - 0.2) / 100).toFixed(2)}}</text>
								</view>
							</view>
