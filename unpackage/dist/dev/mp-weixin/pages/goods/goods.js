...

{
  ...
  onShareAppMessage: function onShareAppMessage(ops) {
    ...
    return {
      ...
      path: "/pages/goods/goods?id=".concat(this.id, "&mid=").concat(mid), //这里设定都是以"/page"开头,并拼接好传递的参数
...
var _goods = _interopRequireDefault(__webpack_require__(/*! ./pages/goods/goods.vue */ 96));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;
